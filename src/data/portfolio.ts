...
export const projects: Project[] = [
  {
    title: "Vista",
    description:
      "Bubble Tea-based TUI in Go to monitor multiple services simultaneously with per-service and interleaved log buffers.",
    tags: ["Go", "Bubble Tea"],
  ...
  },
  {
    title: "BobaFinder",
    description:
      "Multi-agent market entry research system using LangGraph Swarm to determine optimal locations for a boba chain restaurant.",
  ...
  },
  {
    title: "Decanter",
    description:
      "Volunteer management platform for Science Olympiad tournaments with Google OAuth, attracting 75+ users in the first month. 97% test coverage with Vitest.",
