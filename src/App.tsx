  ...
  const employment = [
    {
      ...
      date: '2024',
      description: 'Developed event tree analysis software in C#/.NET WPF with dynamic tree editing.'
    },
    {
      title: 'Teaching Assistant',
      company: 'ScioVirtual Foundation',
      date: '2023 - 2025',
      description: 'Developed course content and coordinated with co-instructors to create contests, assignments, and homework.'
    }
  ]
